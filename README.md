...
본 프로젝트는 DonkeyCar 시뮬레이터 환경에서 수집한 주행 데이터를 기반으로

데이터 정제, AI 학습, AI 검증 및 성능 분석까지 수행할 수 있는 통합 자율주행 학습 플랫폼입니다.

데이터 수집 → 데이터 정제 → 모델 학습 → AI 검증 → 성능 분석 과정을 하나의 프로그램에서 수행할 수 있도록 구현하였습니다.
...
* 범위 선택 삭제 기능
* 이미지 파일 자동 정리
* Catalog / JSON 데이터 동기화
* 삭제 데이터 자동 백업(_deleted)
* 삭제 데이터 복원 기능
* 학습 데이터셋 자동 갱신
...
* 삭제 데이터 복원 기능 구현
* 학습 데이터 자동 정리 기능 구현
* 이미지 및 레코드 동기화 삭제 기능 구현
* Catalog / JSON 데이터 자동 동기화 기능 구현
* 삭제 데이터 백업 시스템 구현
...
* 데이터 수집부터 AI 검증까지의 전체 파이프라인을 GUI 환경에서 통합 제공하여 자율주행 학습 과정을 효율적으로 관리할 수 있는 플랫폼을 구축
...
| 이름 | 담당 역할 |
|--------|--------|
| 김근우 | UI 설계 및 개발 / 데이터 수집 및 관리 |
| 김민욱 | 데이터 처리 로직 구현 / 필터링 기능 개발 |
| 김재민 | AI 모델 설계 및 학습 / 성능 분석 |
